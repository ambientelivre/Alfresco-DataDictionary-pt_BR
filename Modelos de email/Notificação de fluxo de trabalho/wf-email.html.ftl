                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <td>
                                                   <div style="font-size: 22px; padding-bottom: 4px;">
                                                      <#if args.workflowPooled == true>
                                                         Nova task criada
                                                      <#else>
                                                         Nova tarefa direcionada a você
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>
                                                <#if args.workflowPooled == true>
                                                   ...
                                                   A seguinte task foi e criada e está disponível para ser requerida:
                                                <#else>
                                                   Você foi direcionado para a seguite tarefa:
                                                </#if>
                                             </p>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td>
                                                                     <table cellpadding="2" cellspacing="0" border="0">
                                                                        ...
                                                                        <tr>
                                                                           <td>Clique no link para baixar o documento:</td>
                                                                        </tr>
                                                                        <tr>
                                                                           <td>
                           ...
                           <tr>
                              <td style="padding: 0px 30px; font-size: 13px;">
                                 Descubra  Alfresco ${productName!""} visit <a href="http://www.alfresco.com">http://www.alfresco.com</a>
                              </td>
                           </tr>
                           <tr>
                              <td>
